...
//  STYLiSH
//
//  Created by J oyce on 2024/7/28.
//
...
class MenuDetailVC: UIViewController, UICollectionViewDelegate, UITableViewDataSource, UIWebViewDelegate, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        shopPageTableView.register(ShopPageTableViewCell.self, forCellReuseIdentifier: "MenuShopPageTableViewCell")
    }
    ...
    func setupLabels() {
        ...
        titleLabel.frame = CGRect(x: 15, y: labelsY, width: view.frame.width / 2 - 10, height: 30)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "MenuShopPageTableViewCell", for: indexPath) as! ShopPageTableViewCell
        cell.selectionStyle = .none
        cell.configureForType(for: indexPath, data: menu!)
    ...
    func saveCartItem(section: Int) {
        ...
        if shopPageTableView.numberOfRows(inSection: section) > 1 {
            ...
            if let cell = shopPageTableView.cellForRow(at: secondCellIndexPath) as? ShopPageTableViewCell {
                ...
                newItem.imageURL = menu!.images[0]
    ...
    func setupPageControl() {
        ...
        let numberOfPages = menu?.images.count ?? 0
...
extension MenuDetailVC: UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return menu?.images.count ?? 0
    }

    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "photoCell", for: indexPath) as! PhotoCell

        guard let product = menu,
